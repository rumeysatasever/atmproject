...
public class Account {
    ...
    private double calculateSavingBalanceAfterWithdraw(double amount) {
        ...
        savingBalance = savingBalance - amount;//When user wants to withdraw money,their balance will be updated
        return savingBalance;
    }
    ...
    //Interact with the customer to deposit money to their checking account
...
//Interact with the customer to deposit money to their saving account
